...
- Stale EZInventory badge copies `/lua run ezinventory`; plugin/Lua bulk actions; Ctrl+1â9 box hotkeys
...
3. **MQ2OverlayBridge** â in-game MQ plugin for **EMU** (deployed as `MQ2OverlayBridge2.dll`, **API v8**)
4. **Optional data** â EZInventory exports, UltDev item catalog, `Loot.ini`, MQ2Nav / `.navmesh`
...
- Optional **auto-greed under copper threshold** with audit âwhyâ
...
- Macro dependency hints (âused by N macrosâ)
...
Fresh screenshots from a live **EverQuest emulator** session (Valiant / Guild Lobby, bridge connected) â post UI polish pass.

### 1. Status â command center
...
### 4. Inventory â icons, stats, sync
...
### 5. Loot â AdvLoot, filters, peers, council
...
Grouped Config tree (KissAssist, MuleAssist, pluginsâ¦), safe save with backups.
...
*Last updated: July 11, 2026 â v0.7.0-beta.6 Ctrl+Shift+O overlay toggle fix â [eniner/-Coming-Soon-MQ-Companion](https://github.com/eniner/-Coming-Soon-MQ-Companion)*
